    ...
    if (props.newListing) {
      ...
      return (
        <ListingContext.Provider value={{listing, dispatch}}>
          ...
          <Dialog transitionDuration={5} open={editDialogOpen} onClose={()=> setEditDialogOpen(false)} aria-labelledby="listing-edit-form" fullScreen={false} fullWidth={true} maxWidth="xl">
