...
function Amenities (props) {
    ...
    return (
        <>
            ...
            <AmenitiesCheckbox checked={params ? params.pwd_accessable: listingContext.listing.pwd_accessable} handleChange = {props.handleChange} name="pwd_accessable" label="Accessable for persons with disability"/>
