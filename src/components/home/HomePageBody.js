  ...
  window.onresize = function(event) {
    ...
    useEffect(() => {
      ...
      for (const param in params.current ) {
          //if (params.current[param]) queryString = queryString + params.current[param]
    ...
    return (
        <Grid container  >
          ...
          <Grid id="listingsSideBar" item  xs={12} sm={6} md={5} lg={4} style={{zIndex: 1, }}>
            <Paper id="listingsSideBarPaper" className={classes.root} square elevation={4}
            style={{ height: windowHeight -(48 + 10 + 10 + 30) }}>
