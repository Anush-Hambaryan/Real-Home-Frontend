...
function Price(props) {
    ...
    return (
        <>
          {matchesExtraSmall ? 
          <SelectField classes={classes.formControlSelect} value={props.currency} handleChange = {props.handleChange} name="currency" label="Currency" options={SelectFieldOptions.currency} homePage={true}/> 
          : <RadioField label="Currency" name="currency" value={props.currency} handleChange={props.handleChange} options={SelectFieldOptions.currency}/>  }   
